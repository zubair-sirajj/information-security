...
### Step 1: Generating My Keypair  
Then I generated my PGP keypair by running:  
`gpg --gen-key`  

During the setup, I provided my full name and email address, and created a passphrase to protect my private key. Once the process was complete, I confirmed that the keys were successfully generated by listing them with:  
`gpg --list-keys`

This displayed both my public key and my private key.  
...
Next, I created a simple text file with a secret message:
`echo "This is a secret message!" > message.txt`  

Using my public key, I encrypted the message so that only I could decrypt it:
`gpg --encrypt --recipient your_email@example.com --armor message.txt`  

This created a file called message.txt.asc, which contained the encrypted version of my message.  
